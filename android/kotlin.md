...
主要就是在`kotlin+jetpack compose`和`flutter`中间选择，以下是一些考量：

- 我在可预见的未来都不准备使用ios设备，所以flutter多平台的优势在我这被抹平
- jetpack compose使kotlin可以不用XML编写UI，而是转向更现代的组合式函数的方式
...
所以现在让我写android app，我可能会选择`kotlin+jetpack compose`，因为它全栈都是kotlin语言，热重载等功能也基本追上了flutter
